...
Recall that we've solved the simple finite square well problem in Chapter~\ref{finite-square-well} (recall the even parity and odd parity cases). Now we consider the simplest bound state nucleus: a deuteron \ce{^2H}. 

Some facts about deuteron: 
\begin{itemize}
\item \ce{^2_1 H_1} is consist of a neutron and a proton. It's nuclear radius is 2.1 fm. 
