...
\begin{figure}
  \centering
  \subfloat[U/H=0.001]{\label{UH0.01}\includegraphics[width=0.5\textwidth]{images/r-m/Doppler-RI-1.png}}
  \subfloat[U/H=0.1]{\label{UH0.1}\includegraphics[width=0.5\textwidth]{images/r-m/Doppler-RI-2.png}}  
