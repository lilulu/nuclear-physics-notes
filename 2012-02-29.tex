...
Then we arrive at, 
\eqn{ \phi_{WR} (u) &= \frac{\sigma_d}{\sigma_{to}^R (u) - \sigma_{s0}^R (u) + \sigma_d} = \frac{\sigma_d}{\sigma_{a}^R (u) +  \sigma_d }  }
\begin{align}
...
That is, 
\eqn{ \sigma_{po} + \sigma_d &= (\sigma_d + \sigma_{t0} (u)) \phi_{NR} (u) & \phi_{NR} (u) &= \frac{\sigma_{po}^R + \sigma_d}{\sigma_d + \sigma_{to}^R (u)} = \frac{\sigma_{pot}^R + \sigma_d}{\sigma_{a}^R + \sigma_{pot}^R + \sigma_d } }
\begin{align}
...
\item NR: assume the resonance width is small compared to the average energy loss in a collision with the resonant material: 
  \eqn{ \bar{\Delta E}^R = \frac{1 - \alpha^R}{2} E_0 \gg \Gamma_p }
