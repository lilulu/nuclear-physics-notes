...
\lecture{Finite Difference Diffusion Equations (Two Group)}
...
\topic{BCs for Finite-Difference Equation}
...
\eqn{ \boxed{ J_g^N = \frac{2 D_g^N \phi_g^N}{\Delta + C \cdot D_g^N} } } 
\begin{itemize}
...
\lecture{Matrix Representation of 1D Slab Diffusion Equations}
