...
\begin{figure}
    \centering
    \subfloat[Gounde State]{\includegraphics[width=0.5\textwidth]{images/deuteron/deuteron-ground-state.png}}   
    \subfloat[1st Excited State]{\includegraphics[width=0.3\textwidth]{images/deuteron/deuteron-excited-state.png}}
