...
\begin{enumerate}
\item $\kinf$. $\infty$ depend on integrated cross section only (cross sections that treat pin-cells as homogenized preserve exactly the MC fuel reactivity for infinite repeating lattices):
  \begin{enumerate}
  \item One group:  
