...
\eqn{ r_0 \psi(u) &= \int_{u-\epsilon_0}^u \frac{1}{1-\alpha_0} e^{-(u-u')} \overbrace{ \sigma_{so} (u') \psi(u')}^{\mathrm{constant}} \du' = \sigma_s (u) \psi(u)  }
Then we arrive at, 
\eqn{ \psi_{WR} (u) &= \frac{\sigma_d}{\sigma_{to} (u) - \sigma_{s0} (u) + \sigma_d}  }
...
\eqn{ r_0 \psi(u) = \int_{u-\epsilon_0}^u \frac{1}{1- \alpha_0} e^{-(u-u;)} \sigma_{s0}(u') \phi(u') \du' }
...
\eqn{ r_0 \psi(u) = \sigma_{po}}
That is, 
\eqn{ \sigma_{po} + \sigma_d &= (\sigma_d + \sigma_{t0} (u)) \psi_{NR} (u) & \psi_{NR} (u) &= \frac{\sigma_{po} + \sigma_d}{\sigma_d + \sigma_{to} (u) } }
...
\eqn{ \psi_{GC} (u) = \frac{\lambda_g \sigma_{po} + \sigma_d}{\sigma_{to}(u) - (1-\lambda_g) \sigma_{so}(u) + \sigma_d } }
...
\begin{enumerate}
\item One resonant isotope. Assume we have \ce{H_2 O} and \ce{^{235} U}. Then we do, 
\begin{align}
...
\item Multiple resonant isotopes. Assume we have \ce{H_2 O}, \ce{^{235}U}, and \ce{^{238} U}. 
  \begin{enumerate}
  \item Assume \ce{^{235} U} is the only resonant isotope, then 
    \eqn{ \sigma_d = \frac{N_{238} \sigma_{238} + N_H \sigma_H + N_O \sigma_O}{N_{235} } }
