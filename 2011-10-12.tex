...
\hi{Momentum is a generator of translation.} We consider an operator $T$ that moves a $\psi(x)$ to $\psi(x-\Delta x)$: 
...
\topic{Angular Momentum's Commutation Relations}
...
\item Observations: 
  ...
  \item But once we have spin-orbit coupling $l \cdot S$ term, then $J_{1z}, J_{2z}$ are no longer conserved, the two subspaces are coupled, 
    ...
    \eqn{ \mathrm{LHS} &= \Sum_{j = j_1 - j_2}^{j_1 + j_2} (2 j + 1) = \frac{2(j_1 + j_2) + 1 + \cdots 2(j_1 - j_2) + 1}{2} \cross (2 j_2 + 1) = (2j_1 + 1)(2 j_2 + 1) = \mathrm{RHS} } 
...
%%%%%%%%%%%%%%%% end of Fall 2012 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\topic{Orbital Angular Momentum Overview}
