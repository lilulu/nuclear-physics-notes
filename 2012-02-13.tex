...
\lecture{Infinite Medium Monte Carlo Neutronics Tool} \label{slowing-down-thermalization}
...
Reserved space for 22.212. 


\clearpage
\topic{Equilibrium Thermal Elastic Scattering}
